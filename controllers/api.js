...
//     const uri_data = {
//         uri: "https://x78251kcpll2l2t9e46kf96a-wpengine.netdna-ssl.com/wp-content/uploads/2016/07/page-2.2.png"
//     }
//     const response = await axios.post('https://syllabusscanner.cognitiveservices.azure.com/vision/v2.0/recognizeText?mode=Printed', uri_data,
//         {
//             headers:
//             {
//                 "Ocp-Apim-Subscription-Key": "54946fefea6c467395d5b9bf3a6001f7"
//             }
//         }
//     ).then(data => {
//         console.log(data);
...
axios.post('https://syllabusscanner.cognitiveservices.azure.com/vision/v2.0/recognizeText?mode=Printed',
{
    "url":"https://x78251kcpll2l2t9e46kf96a-wpengine.netdna-ssl.com/wp-content/uploads/2016/07/page-2.2.png"
}, 
{
    headers:
    {
  ...
  .then(function (response) {
    axios.get(response.headers['operation-location'], {headers:{
        "Ocp-Apim-Subscription-Key":"54946fefea6c467395d5b9bf3a6001f7"
    }}).then(function(response){
